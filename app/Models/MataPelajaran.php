...
class MataPelajaran extends Model
{
    ...
    protected $fillable = [
        ...
        'id_guru_default', // Guru pengampu utama
        'kkm',
    ...
    /**
     * Mendefinisikan relasi ke Guru (Guru Pengampu Default)
     */
    public function guruDefault()
    {
        return $this->belongsTo(Guru::class, 'id_guru_default', 'id_guru');
    }
