...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'email_siswa' => 'nullable|string|max:100',

            // Dokumen Ujian dan SKHUN
            'skhun' => 'nullable|string|max:50',
            'no_peserta_ujian_nasional' => 'nullable|string|max:50',
            'no_seri_ijazah' => 'nullable|string|max:50',
            'no_registrasi_akta_lahir' => 'nullable|string|max:50',
    ...
    public function downloadTemplate()
    {
        $headers = [
            ...
            'Alamat Lengkap', 'RT', 'RW', 'Dusun', 'Kelurahan', 'Kecamatan', 'Kode Pos', 'Jenis Tinggal', 'Alat Transportasi', 'Jarak Rumah ke Sekolah', 'Lintang', 'Bujur',
            'Telepon Siswa', 'HP Siswa', 'Email Siswa', 'SKHUN', 'No Peserta Ujian Nasional', 'No Seri Ijazah', 'No Registrasi Akta Lahir',
            'Penerima KPS', 'No KPS', 'Penerima KIP', 'Nomor KIP', 'Nama di KIP', 'Nomor KKS', 'Layak PIP', 'Alasan Layak PIP', 'Bank', 'Nomor Rekening Bank', 'Rekening Atas Nama',
            'Kebutuhan Khusus', 'Berat Badan', 'Tinggi Badan', 'Lingkar Kepala',
            'Anak Ke', 'Jumlah Saudara', 'Sekolah Asal', 'Tahun Lulus',
            ...
            'Nama Wali', 'NIK Wali', 'Tahun Lahir Wali', 'Pendidikan Wali', 'Pekerjaan Wali', 'Penghasilan Wali', 'No. HP Wali', 'Alamat Wali'
        ];
    ...
    private function getManualGuesses($headers) {
        ...
        $dbFields = [
            ...
            'rw' => ['rw'],
            'dusun' => ['dusun'],
            'kelurahan' => ['kelurahan', 'desa/kel.', 'desa'],
            'kecamatan' => ['kecamatan', 'kec.'],
            'kode_pos' => ['kode pos'],
            'jenis_tinggal' => ['jenis tinggal', 'status tempat tinggal'],
            'alat_transportasi' => ['alat transportasi', 'transportasi'],
            'jarak_rumah_ke_sekolah' => ['jarak rumah ke sekolah', 'jarak'],
            'lintang' => ['lintang'],
            'bujur' => ['bujur'],
            'telepon_siswa' => ['telepon', 'telp'],
            'hp_siswa' => ['hp', 'no hp', 'handphone'],
            'email_siswa' => ['email', 'e-mail'],
            'skhun' => ['skhun'],
            'no_peserta_ujian_nasional' => ['no peserta ujian', 'no un'],
            'no_seri_ijazah' => ['no seri ijazah', 'no ijazah'],
            'no_registrasi_akta_lahir' => ['no akta lahir', 'no registrasi akta'],
            'penerima_kps' => ['penerima kps'],
            'no_kps' => ['no. kps', 'no kps'],
            'penerima_kip' => ['penerima kip'],
            'nomor_kip' => ['nomor kip', 'no kip'],
            'nama_di_kip' => ['nama di kip', 'nama kip'],
            'nomor_kks' => ['nomor kks', 'no kks'],
            'layak_pip' => ['layak pip'],
            'alasan_layak_pip' => ['alasan layak pip'],
            'bank' => ['bank'],
            'nomor_rekening_bank' => ['nomor rekening bank', 'rekening'],
            'rekening_atas_nama' => ['rekening atas nama'],
            'kebutuhan_khusus' => ['kebutuhan khusus'],
            ...
            'pendidikan_wali' => ['pendidikan wali'],
            'pekerjaan_wali' => ['pekerjaan wali'],
            'penghasilan_wali' => ['penghasilan wali', 'gaji wali'],
            'nik_wali' => ['nik wali']
        ];
