...
export default function Create({ auth, levels }) {
    ...
    return (
        <AdminLayout user={auth.user} header="Tambah User">
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/20 p-4 md:p-6 lg:p-8">
                <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8 animate-fadeIn">
                    ...
                    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 to-indigo-600 p-6 sm:p-8 text-white shadow-xl shadow-blue-500/20">
                        ...
                        <div className="relative flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                            <div>
                                ...
                                <h2 className="text-2xl font-bold tracking-tight">Buat Akun Pengguna Baru</h2>
                                <p className="mt-1 text-blue-100 text-sm max-w-xl">
                                    Lengkapi informasi akun di bawah ini. Pastikan username dan email bersifat unik.
                                </p>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        {/* Kolom Kiri: Rekomendasi/Warning Cerdas */}
                        <div className="lg:col-span-1 space-y-6">
                            <div className="bg-white/70 backdrop-blur-md rounded-3xl p-6 border border-white/40 shadow-xl shadow-slate-200/50">
                                <div className="flex items-center gap-2 mb-4">
                                    <div className="w-1.5 h-5 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-full" />
                                    <h3 className="text-sm font-bold text-gray-800">Petunjuk Pembuatan</h3>
                                </div>

                                {["Admin", "Kepala Sekolah"].includes(data.level) ? (
                                    <div className="space-y-3">
                                        <div className="p-4 rounded-2xl bg-blue-50/50 border border-blue-100 text-blue-800 text-xs leading-relaxed">
                                            <div className="flex items-center gap-2 font-bold mb-1">
                                                <InformationCircleIcon className="h-4 w-4 text-blue-600" />
                                                Role Administratif
                                            </div>
                                            Anda membuat user dengan hak akses administratif (<strong>{data.level}</strong>). Akun ini akan memiliki kontrol atau wewenang peninjauan penuh terhadap data sekolah.
                                        </div>
                                        <p className="text-xs text-slate-500">
                                            Pastikan username yang dipilih profesional dan email yang terdaftar aktif untuk kebutuhan notifikasi atau reset sandi.
                                        </p>
                                    </div>
                                ) : (
                                    <div className="space-y-3">
                                        <div className="p-4 rounded-2xl bg-amber-50 border border-amber-200 text-amber-800 text-xs leading-relaxed">
                                            ...
                                            Untuk pembuatan akun <strong>{data.level}</strong>, sangat direkomendasikan melakukannya melalui menu <strong>Data {data.level}</strong>. 
                                            <br />
                                            Dengan membuat langsung dari sini, user ini tidak akan memiliki data biodata/profil khusus sekolah (seperti NIP, Kelas, Orang Tua, dll) sehingga berpotensi tidak berfungsi penuh di panelnya.
                                        </div>
                                        <div className="text-xs text-slate-400">
                                            Membuat akun di sini biasanya hanya digunakan untuk keperluan pengujian teknis, bukan data riil akademik sekolah.
                                        </div>
                                    </div>
                                )}
                            </div>
                        ...
                        <div className="lg:col-span-2">
                            <div className="bg-white/70 backdrop-blur-md rounded-3xl border border-white/40 p-6 sm:p-8 shadow-xl shadow-slate-200/50 space-y-6">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-800">Detail Akun Pengguna</h3>
                                </div>
                                    ...
                                    <div className="sm:col-span-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                placeholder="Nama lengkap beserta gelar (misal: Adm. Ahmad S.Kom)"
                                            />
                                        </div>
                                        {errors.nama_lengkap && (
