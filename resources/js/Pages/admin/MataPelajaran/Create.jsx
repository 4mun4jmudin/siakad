...
import { PlusIcon, TrashIcon, ChevronLeftIcon, BookOpenIcon, ClockIcon } from "@heroicons/react/24/outline";

export default function Create({ auth, gurus, kelasList }) {
    ...
    return (
        <AdminLayout user={auth.user} header="Tambah Mata Pelajaran">
                ...
                <div className="max-w-[1440px] mx-auto animate-fadeInUp">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-sm text-slate-500 mt-2 font-medium">
                            Isi detail kurikulum mata pelajaran dan atur jadwal mengajar.
                        </p>
                    </div>
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4 border-b border-slate-100/50 pb-4">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 font-medium mt-0.5">Plotting guru dan jam kelas (Opsional, bisa ditambahkan nanti)</p>
                                    </div>
                                </div>
                                <button 
                                    type="button" 
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200/60 bg-white/40 shadow-sm">
                                {data.jadwal.length > 0 ? (
                                    ...
                                    <div className="flex flex-col items-center justify-center py-16 px-4 text-center bg-white/40">
                                        ...
                                        <p className="text-slate-500 text-sm font-medium max-w-sm">Klik tombol "Tambah Baris Jadwal" di atas jika Anda ingin mengatur plotting jadwal sekarang.</p>
                                    </div>
                                )}
                            </div>
                        </div>
